      ...
      <Content>
        <div className="courses">
          ...
          <div className="courses__content">
            ...
            <div className="text">
              <h2>Pedagogia</h2>
              <p>Com o setor da Educação em constante expansão, surgiu a necessidade de mobilizar profissionais para atuarem na área, que vai muito além das salas de aula!</p>
            </div>
          </div>
          <div className="courses__content">
            <div className="img">
